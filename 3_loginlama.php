...
<body>
  <div id="login-page">
    <div class="container">
      <form action="3_loginaksi.php" class="form-login" method="POST" onSubmit="return validasi(this)">
        <h2 class="form-login-heading"><img src="image/pemkab.png" style="width:50px;height:30px;"/>Login Pokir DPRD</h2>
        <!-- <div style="color: red;margin-bottom: 15px;">      
	        ...
	        <div class="login-wrap">
	          ...
	          <div class="login-social-link">
	          	<p>Login Admin? </p>
	            <a href="3_login.php"><button class="btn btn-default" ><i class='fa fa-user'></i> &nbsp;DPRD</button></a>
            <a href="13_loginuser.php"><button class="btn btn-default" ><i class='fa fa-users'></i> &nbsp;SKPD</button></a>
            <a href="14_loginverifikasi.php"><button class="btn btn-default" ><i class='fa fa-users'></i> &nbsp;Veri</button></a> 
	          </div>
	           	<hr>
	          <div class="registration">
	            ...
	            <a class="sub" href="15_regissetwan.php">
	              Setwan
	            </a>
	          </div>
	    	</div>
