...
session_start();
$_SESSION['idskpd']    = $AUser1['user_id'];
$_SESSION['userskpd']   = $AUser1['n_user'];
$_SESSION['namaskpd']   = $AUser1['nama'];
echo '<div id="login-page">
      <div class="container">
        <form  class="form-login" method="post">
        <h2 class="form-login-heading"> BERHASIL! </h2>
        <div class="login-wrap"> 
        <center> <h4>SELAMAT DATANG <br> Anda Login Sebagai Admin SKPD <br> </h4>
        <div> 
...
if ($JLogin2 !== 1) {
  ...
  $_SESSION['userverfikasi']  = $AUser2['n_user'];
