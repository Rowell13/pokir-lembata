...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Awal",sLast:"Akhir",sNext:"Maju",sPrevious:"Mundur"},sEmptyTable:"Data tidak tersedia!",sInfo:"Ditampilkan baris _START_ sampai _END_ dari _TOTAL_ baris data",sInfoEmpty:"Ditampilkan baris 0 sampai 0 dari 0 baris data",
sInfoFiltered:"(Difilter dari _MAX_ total baris data)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Tampil _MENU_ baris data",sLoadingRecords:"Loading data...",sProcessing:"Harap menunggu proses...",sSearch:"Pencarian data:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Data yang dicari tidak tersedia!."},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
