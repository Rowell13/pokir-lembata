...
<body>
  <div id="login-page">
    <div class="container">
      <form action="14_loginverifikasiaksi.php" class="form-login" method="POST" onSubmit="return validasi(this)">
        <h2 class="form-login-heading"><img src="image/pemkab.png" style="width:80px;height:60px;"/>Login Pokir Verifikasi</h2>
        ...
        <div class="login-wrap">
          ...
          <hr>
          <div>
            <a href="3_login.php"><button type="button" class="portal" style="width:32.2%;border-radius:5px;margin-top:-5px;font-family:arial narrow;font-size:16px;"><i class='fa fa-user'></i> &nbsp;Login DPRD</button></a>
