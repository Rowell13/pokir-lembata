  ...
  <section id="container">
    <header class="header black-bg">
     ...
     <section id="main-content">
      <section class="wrapper">
        ...
        <h3><i class="fa fa-angle-right"></i> Rekap Usulan |  <a href="6.usulankegiatan.php?mod=add" class="ace-icon fa fa-plus-circle purple bigger-150"></a></h3>
        <div class="row mb">
    ...
    if ($j_data == 0) {
      ...
      while ($a_usulan = mysql_fetch_array($q_usulan)) {
        ...
        <td>$a_usulan[8]</td>
        <td >$a_usulan[12] </td>         
        <td><input type='hidden' name='id_kirim' value='"; echo $p_id_kirim = $a_usulan[8].$a_usulan[0]; "'><br>
        ...
        <input type='hidden' name='status' value='"; echo $p_status = 'Belum'; "'></td>";
        // if ($a_usulan[12]=='Terkirim') {
        ...
        echo "<a href='#' onclick=\"buka('6.usulankegiatan.php?id_usulan=$a_usulan[0]')\">Map</a>";
          ...
          <a href='8_rekapusulan.php#myModal' class='fa fa-check red bigger-150'> </a> |
    ...
    if ($q_kirim ) {   
       ...
       window.location=("8_rekapusulan.php")
        ...
        $q_update = mysql_query("UPDATE t_rekapusulan SET status = 'Terkirim' 
