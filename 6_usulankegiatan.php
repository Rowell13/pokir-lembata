...
$p_id_reses    = isset($_POST['id_reses']) ? $_POST['id_reses']:"";
...
$p_submit          = "TAMBAH";
if ($p_tombol == "TAMBAH") {
  $tambahusulan = "INSERT INTO t_rekapusulan (id_usulan, id_reses, id_kec, id_desa, usulan, vol, satuan, id_bidang, detail_lokasi, latitude, long_latitude, id_dprd, status) VALUES (
                  '',
                  '$p_id_reses',
                  '$p_id_kecamatan',
                  '$p_id_desa',
